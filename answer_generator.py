...
prompt_node_working = PromptNode("gpt-3.5-turbo", api_key="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", default_prompt_template=lfqa_prompt,model_kwargs={"stream":True})
